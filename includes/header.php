...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>Rent a Car | Hotel Park Srebrenik</title>
			...
			<div class="row">
				...
				<div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
					<nav class="hs_main_menu d-none d-sm-none d-xs-none d-md-block">
						<ul>
							<li> <a class="menu-button single_menu" href="index.php">Naslovna</a>
							</li>
							<li> <a class="menu-button single_menu" href="about.php">O nama</a>
							</li>
							<li> <a class="menu-button single_menu" href="cars.php">Automobili</a>
							</li>
							<li> <a class="menu-button single_menu" href="condition.php">Uslovi najma</a>
							</li>
							<li> <a class="menu-button single_menu" href="contact.php">Kontakt</a>
							</li>
						</ul>
					</nav>
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-6">
									...
									<nav class="cd-dropdown">
										<h2><a href="index.php"><img src="images/logo.png" class="img-responsive" alt="logo" title="Logo" /></a></h2>
										<a href="#0" class="cd-close">Close</a>
										<ul class="cd-dropdown-content">
											<li> <a href="index.php">Naslovna</a>
											</li>
											<li> <a href="about.php">O nama</a>
											</li>
											<li> <a href="cars.php">Automobili</a>
											</li>
											<li> <a href="condition.php">Uslovi najma</a>
											</li>
